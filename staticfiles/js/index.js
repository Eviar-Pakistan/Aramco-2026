...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if(isLoggedIn && window.location.href == "/submit_bonus_entry"){
    window.location.href = "/submit_bonus_entry"
  }
  else if(!isLoggedIn && window.location.href == "/submit_bonus_entry"){
